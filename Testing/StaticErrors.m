...
text(-9,6,['Max error: ' num2str(1000*max(MaxError),'%1.1f') ' mV'],'FontSize',12)
...
text(-9,0.03,['Offset error: ' num2str(1000*p(2),'%1.1f') ' mV'],'FontSize',12)
text(-9,0.02,['Max error: ' num2str(1000*max(MaxError),'%1.1f') ' mV'],'FontSize',12)
